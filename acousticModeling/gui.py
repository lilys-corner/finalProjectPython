...
#What I ADDED START
    ...
    _fetch_title_btn.grid(row=1, column=1, sticky=W, padx=2)

    # Create button for fetching links
    _fetch_link_btn = ttk.Button(
        _url_frame, text='Fetch link', command=fetch_links)
    _fetch_link_btn.grid(row=2, column=1, sticky=W, padx=2)
#WHAT I ADDED END

    # img_frame contains Lisbox and Radio Frame
    _img_frame = ttk.LabelFrame(
        _mainframe, text='Content', padding='9 0 0 0')
    _img_frame.grid(row=3, column=0, sticky=(N, S, E, W))
